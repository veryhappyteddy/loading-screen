...
$APIKey = "8EAF0F8E46916DB2ADB216C708DD0607"; // Go get your API here: http://steamcommunity.com/dev/apikey
			...
			<!--Where the first picture is put in to display -->
				<div class="left-side">
					...
					<div class="middle-left-box">
						...
						<p class="middle-left-box-text">
							The Former Owner is "IN2" And your play ARMA RP
						</p>
				...
				<div class="middle-box">
					...
					<table class="server-info-table" style="width:100%">
						...
						<td style="width:85%">
							Killing your own team will be a warn!
						</td>
					</table>
						<hr class="blue-line2">
					<table class="server-info-table" style="width:100%">
